...
const LandingPage = () => {
  ...
  useEffect(() => {
    const fetchPublicPoll = async () => {
      const publicPoll = await pollsApi.getPublicPolls();

      if (publicPoll?.polls) {
        setPublicPolls(publicPoll.polls);
      }
    };
  ...
  const publicPollsToShow = publicPolls.slice(0, 3);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans antialiased selection:bg-blue-500/30">
      ...
      <nav className="sticky top-0 z-50 border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            <span className="text-lg font-black tracking-wider text-blue-500">
              VOXPOP
            </span>
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-black tracking-tight sm:text-6xl">
              ...
              <span className="text-blue-500">
                Watch Public Sentiments Shift.
              </span>
            </h1>
            <p className="max-w-lg text-lg text-zinc-400">
              Create, share, and vote on decentralized public queries.
              Experience instant response updates driven by an uncompromised
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              <span className="rounded-full bg-blue-500/10 px-2.5 py-0.5 text-xs font-semibold text-blue-400">
                Featured Public Poll
              </span>
              <span className="text-xs text-zinc-500">Expires in 2 days</span>
            </div>
            <h3 className="text-lg font-bold mb-4">
              Which core technology framework will define full-stack engineering
              next?
            </h3>
            <div className="space-y-3">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 rounded-lg border border-zinc-800 bg-zinc-950 p-3 hover:bg-zinc-800/40 transition-all cursor-pointer group"
                >
      ...
      <section
        id="explore"
        className="border-t border-zinc-900 bg-zinc-900/10 py-20"
      >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <p className="mt-2 text-zinc-400 text-sm">
                Cast your vote on active trending global questions right now.
              </p>
            </div>
            <Button
              asChild
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white font-medium"
            >
              <Link to="/public-polls">View All Public Polls</Link>
            </Button>
          </div>

          {/* Dynamic Responsive Grid Layout */}
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {publicPollsToShow.map((publicPoll) => (
              <div
                key={publicPoll.id}
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-zinc-900/60 mt-auto">
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="outline"
                    className="h-8 border-zinc-800 hover:bg-blue-600 hover:border-blue-500 hover:text-white bg-transparent text-xs font-semibold"
                  >
      ...
      <section
        id="about"
        className="border-t border-zinc-900 bg-zinc-950 py-20"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-16">
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
              Built For High-Trust Public Engagement
            </h2>
            <p className="mt-4 text-zinc-400 text-sm sm:text-base">
              We eliminated slow page loads and complex sign-ups so you can
              gauge collective thought instantly.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Every submission renders across connected visitor views instantly without manual state refreshing pages.",
              },
              {
                title: "Expiration Enforcements",
                desc: "Calculations evaluate variables exactly. Once system parameters expire, options securely close.",
              },
              {
                title: "Open Wall Visibility",
                desc: "Public categories remain globally accessible for verification, audit checks, and shared data distribution.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="rounded-xl border border-zinc-900 bg-zinc-900/40 p-6 hover:border-zinc-800 transition-colors"
              >
      ...
      <section
        id="features"
        className="border-t border-zinc-900 bg-zinc-900/20 py-20"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="md:col-span-2 rounded-2xl border border-zinc-900 bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-zinc-800 transition-all">
              <div className="max-w-md space-y-2">
                <h3 className="text-xl font-bold">
                  Dynamic Live Analytical Visualizer
                </h3>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Watch community choices adapt dynamically. As soon as a public
                  voter checks an option, metrics, percentage fills, and total
                  counters adapt fluidly right before your eyes.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-zinc-800 transition-all">
              <div className="space-y-2">
                <h3 className="text-xl font-bold">
                  Automated Expiration Locks
                </h3>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Set your target expiry timestamp and step away. The
                  application securely evaluates date boundaries, preventing
                  additional vote payloads natively.
                </p>
              </div>
              <div className="mt-6 flex items-center justify-center rounded-lg bg-red-500/5 border border-red-500/10 p-4 text-center">
                <span className="font-mono text-sm tracking-widest text-red-400 font-bold animate-pulse">
                  LOCKDOWN ACTIVE
                </span>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-zinc-800 transition-all">
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Accept input responses cleanly without collecting sensitive
                  personal credentials. Protect user identities while
            ...
            <div className="md:col-span-2 rounded-2xl border border-zinc-900 bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-zinc-800 transition-all">
              <div className="max-w-md space-y-2">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Manage your active portfolio effortlessly. Filter through
                  published questions, draft temporary queries, or export clean
                  response logs with a single click.
                </p>
              </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <p className="mt-4 text-zinc-400 text-sm sm:text-base">
              Start hosting public feedback walls for free, or scale up for
              private corporate spaces.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/20 p-8 flex flex-col justify-between hover:border-zinc-800 transition-colors">
              <div className="space-y-4">
                ...
                <p className="text-sm text-zinc-400">
                  Perfect for running community polls, social debates, and open
                  general questions.
                </p>
                <ul className="space-y-2 text-sm text-zinc-300 pt-4 border-t border-zinc-900">
                  ...
                  <li className="flex items-center gap-2">
                    ✔ Instant Live Results Layout
                  </li>
                  <li className="flex items-center gap-2">
                    ✔ 1-Click Expiration Timestamp
                  </li>
                </ul>
              </div>
              <Button
                asChild
                variant="outline"
                className="mt-8 border-zinc-800 text-white hover:bg-zinc-900 bg-transparent"
              >
            ...
            <div className="rounded-2xl border-2 border-blue-600 bg-zinc-900 p-8 flex flex-col justify-between relative shadow-2xl">
              <span className="absolute -top-3 right-4 rounded-full bg-blue-600 px-3 py-0.5 text-xs font-bold text-white tracking-wide">
                POPULAR
              </span>
              <div className="space-y-4">
                <div>
                ...
                <p className="text-sm text-zinc-400">
                  Tailored for content creators, businesses, and targeted user
                  group tracking.
                </p>
                <ul className="space-y-2 text-sm text-zinc-300 pt-4 border-t border-zinc-800">
                  <li className="flex items-center gap-2 text-white font-medium">
                    ✔ Everything in Public Ballot
                  </li>
                  <li className="flex items-center gap-2">
                    ✔ Secure Private Access Routes
                  </li>
                  <li className="flex items-center gap-2">
                    ✔ Advanced Analytics CSV Downloads
                  </li>
                  <li className="flex items-center gap-2">
                    ✔ Custom Identity Authentication Walls
                  </li>
                </ul>
              </div>
              <Button
                asChild
                className="mt-8 bg-blue-600 hover:bg-blue-500 text-white font-semibold"
              >
      ...
      <footer className="border-t border-zinc-900 bg-zinc-950 py-12 text-center text-xs text-zinc-500">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 font-black tracking-wider text-zinc-400">
            <span className="text-blue-500">VOXPOP</span> &copy;{" "}
